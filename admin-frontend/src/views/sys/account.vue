  ...
  <div>
    ...
    <el-card>
      <el-table :data="userList" stripe style="width: 100%">
        ...
        <el-table-column prop="status" label="用户类别" width="180">
          <template slot-scope="scope">
    ...
    >
      <el-form :model="userForm" ref="userFormRef" :rules="rules">
        ...
        <el-form-item v-if="userForm.id == null || false"
                      label="登录密码"
                      prop="password"
                      :label-width="formLabelWidth"
        >
...
<!--        </el-form-item>-->
        <el-form-item label="用户角色" :label-width="formLabelWidth">
          <el-radio-group
            ...
            :max="2">
            <el-radio v-for="role in roleList" :label="role" :key="role">{{role}}</el-radio>
          </el-radio-group>
          <div style="font-size: 12px; color: #666; margin-top: 1px;">选择用户账号对应的角色,不选则默认为普通用户（user）</div>
        </el-form-item>
        <el-form-item
          label="电子邮件"
          prop="email"
