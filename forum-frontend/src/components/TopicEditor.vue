...
<template>
    <div>
        <el-drawer :model-value="show"
            ...
            <template #header>
                <div>
                    <div style="font-weight: bold" v-if="editor.title === ''">发表新的帖子</div>
                    <div style="font-weight: bold" v-else>更新帖子</div>
                    <div style="font-size: 13px">发表内容之前，请遵守相关法律法规，不要出现不文明及违法行为。</div>
                </div>
            </template>
