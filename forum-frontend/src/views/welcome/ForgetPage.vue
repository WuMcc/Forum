<template>
    <div class="login-wrapper">
        ...
        <transition name="el-fade-in-linear" mode="out-in">
            <div style="text-align: center;margin: 0 20px;height: 80%" v-if="active === 0">
                ...
                <div style="margin-top: 70px">
                    <el-button @click="confirmReset()" style="width: 270px;" type="danger">开始重置密码</el-button>
                </div>
              <div style="margin-top: 10px">
                <el-button @click="router.push('/welcome')" style="width: 270px;" type="success">返回上一步</el-button>
              </div>
            </div>
        </transition>
        <transition name="el-fade-in-linear" mode="out-in">
