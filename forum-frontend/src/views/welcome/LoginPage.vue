<template>
  <div class="login-wrapper" style="margin-top: 10px;">
    <h1>登录</h1>
    <div style="text-align: center">
      <el-form :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="username">
          <el-input size="large" :prefix-icon="UserFilled" maxlength="20" placeholder="使用邮箱或者手机号" type="text" v-model="form.username"/>
        </el-form-item>
        <el-form-item prop="password">
          <el-input size="large" clearable :prefix-icon="Lock" show-password placeholder="密码" type="password" v-model="form.password"/>
        </el-form-item>
        <el-form-item prop="remember" style="text-align: center; display: flex; justify-content: center;">
    ...
    <div style="display: flex;justify-content: center;margin-top: 30px">
      <el-button size="large" round color="#87CEFA" style="height: 50px;width: 120px;font-size: 20px" @click="userLogin()">登 录</el-button>
    </div>

    <div class="divider">
      <span class="line"></span>
      <span class="divider-text" style="color: rgb(128,128,128);margin-top: 50px">其他</span>
      <span class="line"></span>
    </div>
    <div class="other-login-wrapper">
        <el-button @click="router.push('/welcome/register')" type="success">注册账号</el-button>
        <el-button  @click="router.push('/')" type="primary">访客浏览</el-button>
        <el-button  @click="router.push('/welcome/forget')" type="danger">忘记密码</el-button>
    </div>
  </div>
</template>
...
@media (max-width: 768px) {
  .box .content {
    width: 100vw;
    height: 100vh;
    background: url("src/assets/login_bg_phone.png") no-repeat;
