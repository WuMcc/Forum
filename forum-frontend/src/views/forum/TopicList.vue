...
import {
  ...
  Link,
  Picture,
  Microphone, CircleCheck, Star, FolderOpened, ArrowRightBold, Refresh, Search
} from "@element-plus/icons-vue";
import Weather from "@/components/Weather.vue";
import {computed, reactive, ref, watch} from "vue";
import {get, unauthorized} from "@/net";
...
get(`/api/forum/notice`, data => notice.text = data.notice)
...
function getSentence(){
  axios.get(`https://tenapi.cn/v2/yiyan?format=json`)
      .then(response => {
        ...
        sentence.author = response.data.data.author;
...
<template>
    <div style="display: flex;margin: 20px auto;gap: 20px;max-width: 900px">
        <div style="flex: 1">
          ...
          >
            <div><b>发帖</b><span>功能需登陆后才能访问，是否前往登录页面？...🚀</span></div>
            <template #footer>
            ...
            <light-card>
                <div class="create-topic" @click="handleClick('edit')">
        ...
        <div style="width: 280px">
            <div style="position: sticky;top: 20px">
                <light-card>
                    <div class="collect-list-button" @click="collects = true" v-if="!isUnauthorized">
              ...
              <div style="font-size: 14px; margin-top: 10px; color: grey; position: relative;">
